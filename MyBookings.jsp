    ...
    <body>
                                    ...
                                    <ul class="nav navbar-nav center_nav pull-right">
                                        ...
                                        <li class="nav-item submenu dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" href="MyBookings.jsp">Shopping Cart</a>
                                                </li>
                                            </ul>
                                        </li>
        ...
        <div style="margin-top: 20rem;">
                ...
                if(ses==null){
                    ...
                    int userId = Integer.parseInt(con.ReadOneData("EB_USER_MST", "EUM_ID", "EUM_EMAIL='" + email + "'"));
                    
                    double totalPrice = 0.0;
                    String query = "SELECT * FROM EB_CART_DTL WHERE EUM_ID=" + userId;
                ...
                <table border='1'>
                    ...
                    <%
                        while (bookings.next()) {
                            int productId= bookings.getInt(6);
                            String userName = con.ReadOneData("EB_USER_MST", "EUM_NAME", "EUM_ID=" + bookings.getInt(5));
                            String productName = con.ReadOneData("EB_PRODUCT_MST", "EPM_NAME", "EPM_ID=" + productId);
                            String photo = con.ReadOneData("EB_PRODUCT_MST", "EPM_PHOTO", "EPM_ID=" + productId);
                            int quantityStock=Integer.parseInt(con.ReadOneData("EB_PRODUCT_MST", "EPM_QUANTITY", "EPM_ID="+productId));
                    ...
                    %>
                    <tr>
                        <td><img src="EB/WebContent/ProductPhotos/<%=photo%>" style="width: 20%;"/></td>
                        <td><%=productName%></td>
                        <td><%=price%></td>
                       <%
                ...
                <div style='text-align: right; padding: 5rem;'><h3>Total Price: <span> <%=totalPrice%></span></h3></div>
        </div>
        <!--================Clients Logo Area =================-->
