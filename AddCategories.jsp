...
<html lang="en">
    ...
    <body>
        ...
        <div style="margin-top: 5rem;">
            <form action="../AddCategoryCode.jsp" method="POST">
                Add New Category:<br>
                <input type="text" name="txtCategory" >
                <br>
                <input type="submit" name="btnSubmit" value="Submit">
            </form>
            <form action="AddCategoryCode.jsp" method="POST" onsubmit="return confirmBox()">
                <div style="font-family:times new roman;">Category Details List</div>
                <div class="check-out" style="">
                    <div class="container">
                        <div class="bs-example4" data-example-id="simple-responsive-table">
                            <div class="table-responsive">
                                <table border="0"  class="table-heading simpleCart_shelfItem" style="width: 50%">
                                    <tr>                                    
                                        <!--<th>ID</th>-->
                                        <th>CATEGORY</th>
                                    ...
                                    <%
                                        ...
                                        ResultSet categoryList = con.ReadRecord("SELECT * FROM EB_CATEGORY_MST ORDER BY ECM_ID ASC");
                                        int id;
                                        String name;
                                        for (int i = 0; categoryList.next(); i++) {
                                            id = categoryList.getInt(1);
                                            name = categoryList.getString(2);
                                    %>
                                    <tr>
                                        <!--<td style="color: black;"><%=id%></td>-->
                                        <td style="color: black;"><%=name%></td>
                                        <td align="center">
                                            <input type="hidden" id="catId" name="catid<%=i%>" value="<%=id%>"/>
                                            <input type="checkbox" id="catName" name="check<%=i%>" value="<%=id%>"/>
                                        </td>
                                    </tr>
                                    <%}
                                    %>
                            ...
                            <input type="submit" class="btn" name="btnDelete" id="btnDelete" formnovalidate onclick="" value="Delete" />
                        </div>
                    </div>
                </div>
            </form>
