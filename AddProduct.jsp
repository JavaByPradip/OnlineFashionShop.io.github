...
<html lang="en">
    ...
    <body>
        ...
        <div style="margin-top: 5rem; width: 30%;">
            <form action="AddProductCode.jsp" method="POST">
                Add New Product<br>
                <div>
                    ...
                    <select name="ddlCategory" id="ddlCategory" class="form-control">
                        ...
                        <%
                            String query = "SELECT * FROM EB_CATEGORY_MST";
                            ResultSet categoryList = con.ReadRecord(query);
                            if (categoryList != null) {
                                while (categoryList.next()) {
                        %>
                        <option value="<%=categoryList.getInt(1)%>"><%=categoryList.getString(2)%></option>
                        <%
                                }
                            }
                        %>
                ...
                <div>
                    ...
                    <input type="number" name="numQuantity" id="numQuantity" class="form-control" />
                </div>
                <br>
...
<script src="rikhi/vendors/lightbox/simpleLightbox.min.js"></script>
<script src="rikhi/vendors/isotope/imagesloaded.pkgd.min.js"></script>
<script src="rikhi/vendors/isotope/isotope-min.js"></script>
<script src="rikhi/vendors/owl-carousel/owl.carousel.min.js"></script>
<script src="rikhi/js/jquery.ajaxchimp.min.js"></script>
<script src="rikhi/vendors/counter-up/jquery.waypoints.min.js"></script>
<script src="rikhi/vendors/flipclock/timer.js"></script>
<script src="rikhi/vendors/counter-up/jquery.counterup.js"></script>
